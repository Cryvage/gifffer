;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  function process(el, gifs, options) {
    ...
    el.onload = function() {
      ...
      gifs.push({"element" : con, "startPlaying" : startPlaying, "stopPlaying" : stopPlaying, "togglePlaying" : togglePlaying, "restartPlaying" : restartPlaying})
      
      con.addEventListener('click', function(){ togglePlaying(duration) })
